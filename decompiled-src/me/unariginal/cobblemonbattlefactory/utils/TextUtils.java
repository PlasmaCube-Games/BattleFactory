...
public class TextUtils {
    public static class_2561 deserialize(String text) {
        return BattleFactory.INSTANCE.audience().toNative(MiniMessage.miniMessage().deserialize((Object)("<!i>" + text)));
    }

    public static List<class_2561> getLoreArray(List<String> lore) {
    ...
    public static List<class_2561> getLoreArray(List<String> lore, class_3222 player) {
        ArrayList<class_2561> loreList = new ArrayList<class_2561>();
        for (String line : lore) {
    ...
    public static List<class_2561> getLoreArray(List<String> lore, TierSettings tierSettings) {
        ArrayList<class_2561> loreList = new ArrayList<class_2561>();
        for (String line : lore) {
    ...
    public static List<class_2561> getLoreArray(List<String> lore, BattleFactoryInstance instance) {
        ArrayList<class_2561> loreList = new ArrayList<class_2561>();
        for (String line : lore) {
    ...
    public static List<class_2561> getLoreArray(List<String> lore, Pokemon pokemon, BattleFactoryInstance instance) {
        ArrayList<class_2561> loreList = new ArrayList<class_2561>();
        for (String line : lore) {
    ...
    public static List<class_2561> getLoreArray(List<String> lore, Pokemon pokemon) {
        ArrayList<class_2561> loreList = new ArrayList<class_2561>();
        for (String line : lore) {
    ...
    public static String parse(String text, class_3222 player) {
        text = TextUtils.parse(text);
        return text.replaceAll("%player.name%", player.method_5820()).replaceAll("%player.uuid%", player.method_5845()).replaceAll("%player.displayName", player.method_5476() != null ? player.method_5476().getString() : "").replaceAll("%player.cooldown%", TextUtils.hms(BattleFactory.INSTANCE.playerCooldowns.containsKey(player.method_5667()) ? BattleFactory.INSTANCE.playerCooldowns.get(player.method_5667()) / 20L : 0L));
    }
